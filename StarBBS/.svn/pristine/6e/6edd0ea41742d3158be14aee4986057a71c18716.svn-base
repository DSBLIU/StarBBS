			...
			<div class="ui-block">
				<div class="top-header">
					<div class="top-header-thumb">
						<img src="/StarBBS/img/top-header1.jpg" alt="nature">
					</div>
						...
						<div class="control-block-button">
							...
							<div class="btn btn-control bg-primary more">
								...
								<ul class="more-dropdown more-with-triangle triangle-bottom-right">
									<li>
										<a href="#" data-toggle="modal" data-target="#update-header-photo">更新个人照片</a>
									</li>
									<li>
										<a href="#" data-toggle="modal" data-target="#update-header-photo">更新标题照片</a>
									</li>
									<li>
					...
					<div class="top-header-author">
						<a href="/StarBBS/star/Personal.jsp" class="author-thumb">
							<img src="/StarBBS/img/author-main1.jpg" alt="author">
						</a>
