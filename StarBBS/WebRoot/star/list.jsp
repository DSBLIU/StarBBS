					...
					str += "<div class='col col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12' >" +
						"<div class='ui-block' id='au'>" +
							"<article class='hentry post has-post-thumbnail thumb-full-width'>" +
								...
								"<div class='post__author author vcard inline-items'>" +
									"<img src='/StarBBS/statics/img/author-page.jpg' alt='author'>" +
								...
								"<a href='#' onclick='article(" + item.id + ")' data-toggle='modal' data-target='#blog-post-popup' class='h2 post-title'>" +
