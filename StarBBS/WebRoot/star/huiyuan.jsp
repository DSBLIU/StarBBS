			...
			<div class="ui-block">
				<div class="ui-block-content">
						...
						<div class="row">
							...
							<div class="col col-lg-4 col-md-4 col-sm-12 col-12">
								<div class="form-group label-floating is-empty" onclick="dj('2')">
									<label class="control-label">1个月</label>
							...
							<div class="col col-lg-4 col-md-4 col-sm-12 col-12">
								<div class="form-group label-floating is-empty" onclick="dj('3')">
									<label class="control-label">3个月</label>
					...
					<div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">	
								<button class="btn btn-primary btn-lg full-width">立即支付！</button>
							</div>
				</div>
			</div>
		</div>
