...
/* 鼠标点击文字特效 */
    ...
    jQuery(document).ready(function($) {
        $("body").click(function(e) {
            var font = new Array("靳春乐","(*╹▽╹*)", "杨阳", "ε٩(๑> ₃ <)۶з","刘杰","(๑•ั็ω•็ั๑)", "刘杨","｡:.ﾟヽ(｡◕‿◕｡)ﾉﾟ.:｡+ﾟ", "张娜娜( ˘•ω•˘ )","( ˘•ω•˘ )", "王瑶✧(๑•̀ㅂ•́)و✧","✧(๑•̀ㅂ•́)و✧", "唐寒强( •̀∀•́ )" ,"( •̀∀•́ )" ," ( ˘ ³˘)♥ ", "(๑ºั ³ ˘๑)", " (●´ϖ`●)", "ლ(´ڡ`ლ)", " ( ◉ืൠ◉ื)");			var color = new Array('#ff0000','#eb4310','#f6941d','#fbb417','#ffff00','#cdd541','#99cc33','#3f9337','#219167','#239676','#24998d','#1f9baa','#0080ff','#3366cc','#333399','#003366','#800080','#a1488e','#c71585','#bd2158');
...
<script type="text/javascript">
	...
	function list(fuzzy, order){
		$.ajax({
			...
			type:"get",
			data:{"mohu":fuzzy, "sort":order == null ? "DA" : order},
			async:"true",
						...
						"<div class='ui-block'>" +
							"<article class='hentry post has-post-thumbnail thumb-full-width'>" +
								...
								"<div class='post-additional-info inline-items'>" +
									...
									"< href='#' class='post-add-icon inline-items'>" +
